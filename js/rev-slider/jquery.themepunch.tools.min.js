...
if (window.tplogs==true)
	try {
		console.groupCollapsed("ThemePunch cobaltSocks Logs");
	} catch(e) { }


var oldgs = window.cobaltSockGlobals;
	oldgs_queue = window._gsQueue;
	
var punchgs = window.cobaltSockGlobals = {};

if (window.tplogs==true)
	try {
		console.info("Build cobaltSock SandBox for ThemePunch Plugins");
		console.info("cobaltSock TweenLite Engine Initalised by ThemePunch Plugin");
	} catch(e) {}
